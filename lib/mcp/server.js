        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                'Include schema: "game-target-1.0" and fictional: true (fictional game content).',
                'Required top-level fields: version, schema, fictional, createdAt (ISO-8601), title, category,',
